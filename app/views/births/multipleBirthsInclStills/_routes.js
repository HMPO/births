module.exports = function (router) {
    ...
    router.post('/births/multipleBirthsInclStills/tasks', function (req, res) {
        ...
        res.redirect('/births/multipleBirthsInclStills/tasks/');
    });

    router.post('/births/multipleBirthsInclStills/childsDetails/name-date-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetails/mothers-name-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetails/mothers-details-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetails/fathers-name-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/stats/voluntary-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/submit/register-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/submit/check-answers-complete', function (req, res) {
        req.session.data = req.session.data || {};

        req.session.data.checkAnswersCompleted = true;

        res.redirect('/births/multipleBirthsInclStills/submit/confirmation');
    });

    router.post('/births/multipleBirthsInclStills/child2Details/place-check', function (req, res) {
        req.session.data = req.session.data || {};
        ...
        res.redirect('/births/multipleBirthsInclStills/tasks/child2index.html');
    });

    router.post('/births/multipleBirthsInclStills/child2Details/name-date-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetailsChild2/mothers-name-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetailsChild2/mothers-details-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetailsChild2/fathers-name-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/parentsDetailsChild2/fathers-details-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/statsChild2/confidential-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/statsChild2/voluntary-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/submitChild2/register-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/submitChild2/check-answers-complete', function (req, res) {
        req.session.data = req.session.data || {};

        req.session.data.child2CheckAnswersCompleted = true;

        res.redirect('/births/multipleBirthsInclStills/submitChild2/confirmation-page-child2');
    });

    router.post('/births/multipleBirthsInclStills/additionalInfoChild2/comments-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.get('/births/multipleBirthsInclStills/submitChild2/confirmation-page-child2', function (req, res) {

        req.session.data = {};

        res.render('births/multipleBirthsInclStills/submitChild2/confirmation-page-child2');
    });


    router.get('/births/multipleBirthsInclStills/child2/mark-complete', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/additionalInfo/comments-check', function (req, res) {
        req.session.data = req.session.data || {};
    ...
    router.post('/births/multipleBirthsInclStills/additionalInfoChild2/comments-check', function (req, res) {
        ...
        const referer = req.get('Referer') || '/births/multipleBirthsInclStills/tasks/child2index.html';
